...
function draw() {
  ...
  textSize(15);
  text("Seta para cima = Escovar",20, 55);
  text("Seta para baixo = Exercitar",20, 70);
  text("Seta para a esquerda = Comer",20, 85);
  text("Seta para a direita = Banho",20, 100);
  text("tecla m = Movimentar",20, 115);
